    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Edit Unit Kerja</h3>
        ...
        <div class="card-body">
            ...
            <form action="<?= $action; ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="unit_kerja" class="form-control" placeholder="Inputkan Unit Kerja" value="<?= isset($unit['un_nama']) ? $unit['un_nama'] : NULL ?>" required>
                </div>
                <button type="submit" name="simpan" class="btn btn-primary mr-2">Simpan</button>
                <a class="btn btn-light" href="<?= site_url('unit'); ?>">Batal</a>
            </form>
        </div>
    </div>
</div>