    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Tambah Unit Kerja</h3>
...
<div class="col-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?= site_url("unit/add") ?>" method="post">
                <div class="form-group">
                    <label>Unit Kerja</label>
                    <input type="text" name="unit_kerja" class="form-control" placeholder="Inputkan Unit Kerja" required>
                </div>
