          ...
          <div class="card">
            ...
            <div class="row justify-content-center">
              <div class="col-4 col-lg-4 order-lg-2">
                <div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
                    ...
                    <img src="https://i.ibb.co/T2rVr3B/ppinfra.png" alt="ppinfra" border="0" class="align-items-center" style="margin-left: 20px">
           ...
           <div class="col-md-12 container-fluid">
            ...
            <div class="h-100">
              ...
              <p class="mb-0 font-weight-bold text-sm" style="margin-left: 20px">
               No.&nbsp;&nbsp;   <?= isset($spd['nomor']) ? $spd['nomor'] : NULL ?>
              </p>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <?php
                 ...
                 <div class="col-md-6 hidden">
                  ...
                  <input class="form-control" type="text" name="nomor" value="<?= isset($spd['nomor']) ? $spd['nomor'] : NULL ?>" hidden  >
                  </div>
                </div>
              <!--   <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control" type="date" name="kembali" value="<?= isset($spd['kembali']) ? $spd['kembali'] : NULL ?>">
                  </div>
                </div>
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="transportasi">
                      <option value="<?= isset($spd['transportasi']) ? $spd['transportasi'] : NULL ?>"
                            selected="selected"><?= isset($spd['transportasi']) ? $spd['transportasi'] : NULL ?>
                        </option>
                ...
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" name="urusan"><?= isset($spd['urusan']) ? $spd['urusan'] : NULL ?></textarea>
                  </div>
                </div>
