          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Ubah Data Pengajuan Cuti</p>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="tgl_awal" value="<?= isset($spd['tgl_awal']) ? $spd['tgl_awal'] : NULL ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Tanggal Akhir Cuti</label>
                    <input class="form-control" type="date" name="tgl_akhir" value="<?= isset($spd['tgl_akhir']) ? $spd['tgl_akhir'] : NULL ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Keterangan</label>
                  <textarea class="form-control" name="keterangan"><?= isset($spd['keterangan']) ? $spd['keterangan'] : NULL ?></textarea>
                  </div>
                </div>
